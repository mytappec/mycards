...
function colorField(id, label, value) {
  return `<div>${label}<div class="color-field"><input type="color" class="colorPicker" id="${id}" value="${value}"><input type="text" class="colorHex" id="${id}_hex" value="${value}"></div></div>`;
}
