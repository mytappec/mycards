...
<style>
  ...
  *{box-sizing:border-box;}
  body{margin:0;min-height:100vh;background:var(--page-bg);font-family:'Quicksand','Segoe UI',sans-serif;padding:36px 16px;}
...
function renderSuspendedPage(b, platformName) {
  ...
  <body>
    <div class="box">
      <p><b>Ups! ¿Olvidaste pagar tu suscripción? 😴</b><br><br>Por favor envíanos el comprobante a "<a href="mailto:mytapp.ec@gmail.com">mytapp.ec@gmail.com</a>" con el nombre de tu negocio y continúa disfrutando de <span style="white-space:nowrap;">${escapeHtml(platformName)}</span>.</p>
    </div>
  </body></html>`;
}
...
function renderStaffLogin(b, platformName) {
  ...
  <body>
    <div class="mytapp-corner">${escapeHtml(platformName)}, una marca de <a href="https://www.instagram.com/anaeli.brand" target="_blank" rel="noopener">Anaelí Brand</a></div>
    <div class="box">
